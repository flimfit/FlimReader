...
mex('-outdir', outdir,...
    ...
    [cdir 'FLIMReader' filesep 'AbstractFifoReader.cpp'], ...
    [cdir 'FLIMReader' filesep 'PicoquantTTRReader.cpp'], ...
    [cdir 'FLIMReader' filesep 'PicoquantPTUReader.cpp'], ...
    [cdir 'FLIMReader' filesep 'FFDReader.cpp'], ...
    [cdir 'FLIMReader' filesep 'FLIMReader.cpp'], ...
    [cdir 'FLIMReader' filesep 'TextReader.cpp'], ...
    [cdir 'FLIMReader' filesep 'FrameWarpAligner.cpp'], ...
    [cdir 'FLIMReader' filesep 'TransformInterpolator.cpp'], ...
    [cdir 'FLIMReader' filesep 'AbstractFrameAligner.cpp'], ...
    ['-I' cdir 'FLIMreader'], ...
